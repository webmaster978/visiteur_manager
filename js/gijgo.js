...
gj.grid.plugins.inlineEditing.config = {
    base: {
        ...
        inlineEditing: {
             ...
             *     });
             * </script>
             * @example DateTime <!-- datetimepicker1, grid -->
             * <table id="grid"></table>
             * <script>
             *     var grid, data = [
            ...
            if (column.editor) {
                ...
                if ($editorField.length) {
                    ...
                    if (typeof(column.editor) === 'function') {
                        ...
                        if ('checkbox' === column.type && gj.checkbox) {
                        ...
                        } else if (('date' === column.type && gj.datepicker) || ('time' === column.type && gj.timepicker1) || ('datetime' === column.type && gj.datetimepicker1)) {
                            ...
                            switch (column.type) {
                                case 'date':
                                    ...
                                    break;
                                case 'time':
                                    $editorField = $editorField.timepicker1(config);
                                    break;
                                case 'datetime':
                                    $editorField = $editorField.datetimepicker1(config);
                                    break;
                            }
...
gj.timepicker1.config = {
    base: {

        /** The width of the timepicker1.
         * @type number
         * @default undefined
         * @example JS.Config <!-- timepicker1 -->
         * <input id="timepicker1" width="312" />
         * <script>
         *    $('#timepicker1').timepicker1({ width: 280 });
         * </script>
         * @example HTML.Config <!-- timepicker1 -->
         * <input id="timepicker1" width="312" />
         * <script>
        ...
        /** If set to true, the timepicker1 will have modal behavior.
         * @type Boolean
         * @default true
         * @example True <!-- timepicker1 -->
         * <input id="timepicker1" width="280" />
         * <script>
         *    $('#timepicker1').timepicker1({ modal: true });
         * </script>
         * @example False <!-- timepicker1 -->
         * <input id="timepicker1" width="280" />
         * <script>
         *    $('#timepicker1').timepicker1({ modal: false, header: false, footer: false });
         * </script>
         */
        modal: true,

        /** If set to true, add header to the timepicker1.
         * @type Boolean
         * @default true
         * @example True <!-- timepicker1 -->
         * <input id="timepicker1" width="280" />
         * <script>
         *    $('#timepicker1').timepicker1({ header: true });
         * </script>
         * @example False <!-- timepicker1 -->
         * <input id="timepicker1" width="280" />
         * <script>
         *    $('#timepicker1').timepicker1({ header: false, mode: '24hr' });
         * </script>
         */
        header: true,

        /** If set to true, add footer with ok and cancel buttons to the timepicker1.
         * @type Boolean
         * @default true
         * @example True <!-- timepicker1 -->
         * <input id="timepicker1" width="280" />
         * <script>
         *    $('#timepicker1').timepicker1({ footer: true });
         * </script>
         * @example False <!-- timepicker1 -->
         * <input id="timepicker1" width="280" />
         * <script>
         *    $('#timepicker1').timepicker1({ footer: false });
         * </script>
         */
        footer: true,

        /** Specifies the format, which is used to format the value of the timepicker1 displayed in the input.
         ...
         * @type String
         * @default 'MM:HH'
         * @example Sample <!-- timepicker1 -->
         * <input id="timepicker1" width="312" value="13.42" />
         * <script>
         *     var timepicker1 = $('#timepicker1').timepicker1({
         *         format: 'HH.MM'
         *     });
         * </script>
         */
         ...
         * @type (materialdesign|bootstrap|bootstrap4)
         * @default materialdesign
         * @example MaterialDesign <!-- timepicker1 -->
         * <input id="timepicker1" width="312" />
         * <script>
         *    $('#timepicker1').timepicker1({ uiLibrary: 'materialdesign' });
         * </script>
         * @example Bootstrap.3 <!-- bootstrap, timepicker1 -->
         * <input id="timepicker1" width="270" />
         * <script>
         *     $('#timepicker1').timepicker1({ uiLibrary: 'bootstrap', modal: false, footer: false });
         * </script>
         * @example Bootstrap.4 <!-- bootstrap4, timepicker1 -->
         * <input id="timepicker1" width="276" />
         * <script>
         *     $('#timepicker1').timepicker1({ uiLibrary: 'bootstrap4' });
         * </script>
         */
        uiLibrary: 'materialdesign',

        /** The initial timepicker1 value.
         * @type String
         * @default undefined
         * @example Javascript <!-- timepicker1 -->
         * <input id="timepicker1" width="312" />
         * <script>
         *    $('#timepicker1').timepicker1({
         *        value: '13:42'
        ...
        /** The timepicker1 mode. Tells the component to display the picker in ampm (12hr) format or 24hr format.
         * @type ampm|24hr
         * @default 'ampm'
         * @example ampm <!-- timepicker1 -->
         * <input id="timepicker1" width="312" />
         * <script>
         *    $('#timepicker1').timepicker1({ mode: 'ampm' });
         * </script>
         * @example 24hr <!-- timepicker1 -->
         * <input id="timepicker1" width="312" />
         * <script>
         *     $('#timepicker1').timepicker1({ mode: '24hr' });
         * </script>
         */
        mode: 'ampm',
        ...
        /** The size of the timepicker1 input.
         * @type 'small'|'default'|'large'
         * @default 'default'
         * @example Bootstrap.4 <!-- bootstrap4, timepicker1 -->
         * <p><label for="timepicker1-small">Small Size:</label> <input id="timepicker1-small" width="220" value="15:20" /></p>
         * <p><label for="timepicker1-default">Default Size:</label> <input id="timepicker1-default" width="220" value="15:20" /></p>
         * <p><label for="timepicker1-large">Large Size:</label> <input id="timepicker1-large" width="220" value="15:20" /></p>
         * <script>
         *     $('#timepicker1-small').timepicker1({ uiLibrary: 'bootstrap4', size: 'small' });
         *     $('#timepicker1-default').timepicker1({ uiLibrary: 'bootstrap4', size: 'default' });
         *     $('#timepicker1-large').timepicker1({ uiLibrary: 'bootstrap4', size: 'large' });
         * </script>
         * @example Bootstrap.3 <!-- bootstrap, timepicker1 -->
         * <p><label for="timepicker1-small">Small Size:</label> <input id="timepicker1-small" width="220" value="15:20" /></p>
         * <p><label for="timepicker1-default">Default Size:</label> <input id="timepicker1-default" width="220" value="15:20" /></p>
         * <p><label for="timepicker1-large">Large Size:</label> <input id="timepicker1-large" width="220" value="15:20" /></p>
         * <script>
         *     $('#timepicker1-small').timepicker1({ uiLibrary: 'bootstrap', size: 'small' });
         *     $('#timepicker1-default').timepicker1({ uiLibrary: 'bootstrap', size: 'default' });
         *     $('#timepicker1-large').timepicker1({ uiLibrary: 'bootstrap', size: 'large' });
         * </script>
         * @example Material.Design <!-- timepicker1 -->
         * <p><label for="timepicker1-small">Small Size:</label> <input id="timepicker1-small" width="220" value="15:20" /></p>
         * <p><label for="timepicker1-default">Default Size:</label> <input id="timepicker1-default" width="220" value="15:20" /></p>
         * <p><label for="timepicker1-large">Large Size:</label> <input id="timepicker1-large" width="220" value="15:20" /></p>
         * <script>
         *     $('#timepicker1-small').timepicker1({ size: 'small' });
         *     $('#timepicker1-default').timepicker1({ size: 'default' });
         *     $('#timepicker1-large').timepicker1({ size: 'large' });
         * </script>
         */
        size: 'default',
        ...
        style: {
            modal: 'gj-modal',
            wrapper: 'gj-timepicker1 gj-timepicker1-md gj-unselectable',
            input: 'gj-textbox-md',
            clock: 'gj-picker gj-picker-md timepicker1',
            footer: '',
            button: 'gj-button-md'
        }
    },
    ...
    bootstrap: {
        style: {
            wrapper: 'gj-timepicker1 gj-timepicker1-bootstrap gj-unselectable input-group',
            input: 'form-control',
            clock: 'gj-picker gj-picker-bootstrap timepicker1',
            footer: 'modal-footer',
            button: 'btn btn-default'
        },
        iconsLibrary: 'glyphicons'
...
gj.timepicker1.methods = {
    init: function(jsConfig) {
        gj.picker.widget.prototype.init.call(this, jsConfig, 'timepicker1');
        return this;
    },
    ...
    initMouse: function($body, $input, $picker, data) {
        $body.off();
        $body.on('mousedown', gj.timepicker1.methods.mouseDownHandler($input, $picker));
        $body.on('mousemove', gj.timepicker1.methods.mouseMoveHandler($input, $picker, data));
        $body.on('mouseup', gj.timepicker1.methods.mouseUpHandler($input, $picker, data));
    },

    createPicker: function($timepicker1) {
        var date, data = $timepicker1.data(),
            $clock = $('<div role="picker" />').addClass(data.style.clock).attr('guid', $timepicker1.attr('data-guid')),
            $hour = $('<div role="hour" />'),
        ...
        if (!date || isNaN(date.getTime())) {
            ...
            $timepicker1.attr('hours', date.getHours());
        }

        gj.timepicker1.methods.initMouse($body, $timepicker1, $clock, data);

        if (data.header) {
            $hour.on('click', function() {
                gj.timepicker1.methods.renderHours($timepicker1, $clock, data);
            });
            $minute.on('click', function() {
                gj.timepicker1.methods.renderMinutes($timepicker1, $clock, data);
            });
            $header.append($hour).append(':').append($minute);
            if (data.mode === 'ampm') {
                $mode.append($('<span role="am">' + gj.core.messages[data.locale].am + '</span>').on('click', function() {
                    var hour = gj.timepicker1.methods.getHour($clock);
                    $clock.attr('mode', 'am');
                    ...
                    if (!data.modal) {
                        clearTimeout($timepicker1.timeout);
                        $timepicker1.focus();
                    }
                }));
                $mode.append('<br />');
        ...
        if (data.footer) {
            $btnCancel.on('click', function() { $timepicker1.close(); });
            $footer.append($btnCancel);
            $btnOk.on('click', gj.timepicker1.methods.setTime($timepicker1, $clock));
            $footer.append($btnOk);
            $clock.append($footer);
        }
    ...
    setTime: function($timepicker1, $clock) {
        return function() {
            var hour = gj.timepicker1.methods.getHour($clock),
                minute = gj.timepicker1.methods.getMinute($clock),
                mode = $clock.attr('mode'),
                date = new Date(0, 0, 0, (hour === 12 && mode === 'am' ? 0 : hour), minute),
                data = $timepicker1.data(),
                value = gj.core.formatDate(date, data.format, data.locale);
    ...
    updateArrow: function(e, $timepicker1, $clock, data) {
        var rect, value,
            mouseX = $timepicker1.mouseX(e),
            mouseY = $timepicker1.mouseY(e),
            scrollY = window.scrollY || window.pageYOffset || 0,
            scrollX = window.scrollX || window.pageXOffset || 0;

        rect = e.target.getBoundingClientRect();
        if (data.dialMode == 'hours') {
            value = gj.timepicker1.methods.getPointerValue(mouseX - scrollX - rect.left, mouseY - scrollY - rect.top, data.mode);
            $clock.attr('hour', data.mode === 'ampm' && $clock.attr('mode') === 'pm' && value < 12 ? value + 12 : value);
        } else if (data.dialMode == 'minutes') {
            value = gj.timepicker1.methods.getPointerValue(mouseX - scrollX - rect.left, mouseY - scrollY - rect.top, 'minutes');
            $clock.attr('minute', value);
        }

        gj.timepicker1.methods.update($timepicker1, $clock, data);
    },

    update: function($timepicker1, $clock, data) {
        var hour, minute, $arrow, visualHour, $header, $numbers;

        // update the arrow
        hour = gj.timepicker1.methods.getHour($clock);
        minute = gj.timepicker1.methods.getMinute($clock);
    ...
    mouseDownHandler: function($timepicker1, $clock) {
        return function(e) {
            $timepicker1.mouseMove = true;
        }
    },

    mouseMoveHandler: function($timepicker1, $clock, data) {
        return function(e) {
            if ($timepicker1.mouseMove) {
                gj.timepicker1.methods.updateArrow(e, $timepicker1, $clock, data);
            }
        }
    },

    mouseUpHandler: function($timepicker1, $clock, data) {
        return function(e) {
            gj.timepicker1.methods.updateArrow(e, $timepicker1, $clock, data);
            $timepicker1.mouseMove = false;
            if (!data.modal) {
                clearTimeout($timepicker1.timeout);
                $timepicker1.focus();
            }
            if (data.dialMode == 'hours') {
                setTimeout(function() {
                    gj.timepicker1.events.select($timepicker1, 'hour');
                    gj.timepicker1.methods.renderMinutes($timepicker1, $clock, data);
                }, 1000);
            } else if (data.dialMode == 'minutes') {
                if (data.footer !== true && data.autoClose !== false) {
                    gj.timepicker1.methods.setTime($timepicker1, $clock)();
                }
                gj.timepicker1.events.select($timepicker1, 'minute');
            }
        }
    },

    renderHours: function($timepicker1, $clock, data) {
    ...
    renderMinutes: function($timepicker1, $clock, data) {
    ...
    open: function($timepicker1) {
        var time, hour, data = $timepicker1.data(),
            $clock = $('body').find('[role="picker"][guid="' + $timepicker1.attr('data-guid') + '"]');

        if ($timepicker1.value()) {
            time = gj.core.parseDate($timepicker1.value(), data.format, data.locale);
        } else {
            time = new Date();
        }
        hour = time.getHours();
        ...
        gj.picker.widget.prototype.open.call($timepicker1, 'timepicker1');
        return $timepicker1;
    },

    value: function($timepicker1, value) {
        var $clock, time, data = $timepicker1.data();
        if (typeof(value) === "undefined") {
            return $timepicker1.val();
        } else {
            $timepicker1.val(value);
            gj.timepicker1.events.change($timepicker1);
            return $timepicker1;
        }
    }
};

gj.timepicker1.events = {
    /**
     * Triggered when the timepicker1 value is changed.
     *
     * @event change
     * @param {object} e - event data
     * @example sample <!-- timepicker1 -->
     ...
     * </script>
     */
    change: function($timepicker1) {
        return $timepicker1.triggerHandler('change');
    },
     ...
     * </script>
     */
    select: function($timepicker1, type) {
        return $timepicker1.triggerHandler('select', [type]);
    },

    /**
     * Event fires when the timepicker1 is opened.
     * @event open
     * @param {object} e - event data
     * @example sample <!-- timepicker1 -->
     * <input id="timepicker1" width="312" />
     ...
     */
    open: function($timepicker1) {
        return $timepicker1.triggerHandler('open');
    },

    /**
     * Event fires when the timepicker1 is closed.
     * @event close
     * @param {object} e - event data
     * @example sample <!-- timepicker1 -->
     * <input id="timepicker1" width="312" />
     ...
     * </script>
     */
    close: function($timepicker1) {
        return $timepicker1.triggerHandler('close');
    }
};

gj.timepicker1.widget = function($element, jsConfig) {
    var self = this,
        methods = gj.timepicker1.methods;

    self.mouseMove = false;

    /** Gets or sets the value of the timepicker1.
     * @method
     * @param {string} value - The value that needs to be selected.
     * @return string
     * @example Get <!-- timepicker1 -->
     * <button class="gj-button-md" onclick="alert($timepicker1.value())">Get Value</button>
     * <hr/>
     * <input id="timepicker1" width="312" />
     * <script>
     *     var $timepicker1 = $('#timepicker1').timepicker1();
     * </script>
     * @example Set <!-- timepicker1 -->
     * <button class="gj-button-md" onclick="$timepicker1.value('11:00')">Set Value</button>
     * <hr/>
     * <input id="timepicker1" width="312" />
     * <script>
     *     var $timepicker1 = $('#timepicker1').timepicker1();
    ...
    /** Remove timepicker1 functionality from the element.
     * @method
     * @return jquery element
     * @example sample <!-- timepicker1 -->
     * <button class="gj-button-md" onclick="timepicker1.destroy()">Destroy</button>
     * <input id="timepicker1" width="312" />
     * <script>
     *     var timepicker1 = $('#timepicker1').timepicker1();
     * </script>
     */
    self.destroy = function() {
        return gj.picker.widget.prototype.destroy.call(this, 'timepicker1');
    };

    /** Open the clock.
     * @method
     * @return timepicker1
     * @example Open.Close <!-- timepicker1 -->
     * <button class="gj-button-md" onclick="$timepicker1.open()">Open</button>
     * <button class="gj-button-md" onclick="$timepicker1.close()">Close</button>
     * <hr/>
     * <input id="timepicker1" width="312" />
     * <script>
     *     var $timepicker1 = $('#timepicker1').timepicker1({ modal: false, header: false, footer: false, mode: '24hr' });
     * </script>
     */
    self.open = function() {
        return gj.timepicker1.methods.open(this);
    };
     ...
     */
    self.close = function() {
        return gj.picker.widget.prototype.close.call(this, 'timepicker1');
    };

    $.extend($element, self);
    if ('true' !== $element.attr('data-timepicker1')) {
        methods.init.call($element, jsConfig);
    }
...
gj.timepicker1.widget.prototype = new gj.picker.widget();
gj.timepicker1.widget.constructor = gj.timepicker1.widget;

(function($) {
    $.fn.timepicker1 = function(method) {
        var $widget;
        if (this && this.length) {
            if (typeof method === 'object' || !method) {
                return new gj.timepicker1.widget(this, method);
            } else {
                $widget = new gj.timepicker1.widget(this, null);
                if ($widget[method]) {
                    return $widget[method].apply(this, Array.prototype.slice.call(arguments, 1));
                } else {
                    throw 'Method ' + method + ' does not exist.';
...
gj.datetimepicker1.config = {
    base: {

        /** The datepicker configuration options. Valid only for datepicker specific configuration options.
         * @additionalinfo All configuration options that exists on the datetimepicker1 level are going to override the options at datepicker level.
         * @type object
         * @default undefined
         * @example Sample <!-- datetimepicker1 -->
         * <input id="datetimepicker1" width="312" />
         * <script>
        ...
        timepicker1: gj.timepicker1.config.base,

        /** The name of the UI library that is going to be in use.
         * @additionalinfo The css file for bootstrap should be manually included if you use bootstrap.
         * @type (materialdesign|bootstrap|bootstrap4)
         * @default materialdesign
         * @example MaterialDesign <!-- datetimepicker1 -->
         * <input id="datetimepicker1" width="312" />
         * <script>
         *    $('#datetimepicker1').datetimepicker1({ uiLibrary: 'materialdesign' });
         * </script>
         * @example MaterialDesign.Modal <!-- datetimepicker1 -->
         * <input id="datetimepicker1" width="312" />
         * <script>
         *    $('#datetimepicker1').datetimepicker1({ uiLibrary: 'materialdesign', modal: true, footer: true });
         * </script>
         * @example Bootstrap.3 <!-- bootstrap, datetimepicker1 -->
         * <input id="datetimepicker1" width="220" />
         * <script>
         *     $('#datetimepicker1').datetimepicker1({ uiLibrary: 'bootstrap' });
         * </script>
         * @example Bootstrap.4 <!-- bootstrap4, datetimepicker1 -->
         * <input id="datetimepicker1" width="234" />
         * <script>
         *     $('#datetimepicker1').datetimepicker1({ uiLibrary: 'bootstrap4', modal: true, footer: true });
         * </script>
         */
        uiLibrary: 'materialdesign',

        /** The initial datetimepicker1 value.
         * @type number
         * @default undefined
         * @example Javascript <!-- datetimepicker1 -->
         * <input id="datetimepicker1" width="300" />
         * <script>
         *    $('#datetimepicker1').datetimepicker1({ value: '22:10 03/27/2018' });
         * </script>
         * @example HTML <!-- datetimepicker1 -->
         * <input id="datetimepicker1" width="300" value="22:10 03/27/2018" />
         * <script>
         *     $('#datetimepicker1').datetimepicker1();
         * </script>
         */
         ...
         * <script>
         *     $('#input').datetimepicker1({ format: 'HH:MM yyyy-dd-mm' });
         * </script>
         * @example Long.Month.Format <!-- datetimepicker1 -->
         * <input id="input" value="10 October 2017 05:50" width="312" />
         * <script>
         *     $('#input').datetimepicker1({ format: 'dd mmmm yyyy HH:MM' });
         * </script>
         */
        format: 'HH:MM mm/dd/yyyy',

        /** The width of the datetimepicker1.
         * @type number
         * @default undefined
         * @example JS.Config <!-- datetimepicker1 -->
         * <input id="input" />
         * <script>
         *    $('#input').datetimepicker1({ width: 312 });
         * </script>
         * @example HTML.Config <!-- datetimepicker1 -->
        ...
        /** If set to true, the datetimepicker1 will have modal behavior.
         * @type Boolean
         * @default false
         * @example Material.Design <!-- datetimepicker1 -->
         * <input id="input" width="312" />
         * <script>
         *    $('#input').datetimepicker1({ modal: true });
         * </script>
         * @example Bootstrap <!-- bootstrap, datetimepicker1 -->
         * <input id="input" width="220" />
         * <script>
         *    $('#input').datetimepicker1({ uiLibrary: 'bootstrap', modal: true, footer: true });
         * </script>
         * @example Bootstrap.4 <!-- bootstrap4, datetimepicker1 -->
         * <input id="input" width="234" />
         * <script>
         *    $('#input').datetimepicker1({ uiLibrary: 'bootstrap4', modal: true, footer: true });
         * </script>
         */
        modal: false,

        /** If set to true, add footer with ok and cancel buttons to the datetimepicker1.
         * @type Boolean
         * @default false
         * @example True <!-- datetimepicker1 -->
         * <input id="input" width="312" />
         * <script>
         *    $('#input').datetimepicker1({ footer: true, modal: true, header: true });
         * </script>
         * @example False <!-- datetimepicker1 -->
         * <input id="input" width="312" />
         * <script>
         *    $('#input').datetimepicker1({ footer: false });
         * </script>
         */
        footer: false,

        /** The size of the datetimepicker1 input.
         * @type 'small'|'default'|'large'
         * @default 'default'
         * @example Bootstrap.4 <!-- bootstrap4, datetimepicker1 -->
         ...
         * <script>
         *     $('#small').datetimepicker1({ uiLibrary: 'bootstrap4', size: 'small' });
         *     $('#default').datetimepicker1({ uiLibrary: 'bootstrap4', size: 'default' });
         *     $('#large').datetimepicker1({ uiLibrary: 'bootstrap4', size: 'large' });
         * </script>
         * @example Bootstrap.4.Font.Awesome <!-- bootstrap4, fontawesome, datetimepicker1 -->
         * <p><label for="small">Small Size:</label> <input id="small" width="234" value="10:20 03/20/2018" /></p>
         * <p><label for="default">Default Size:</label> <input id="default" width="234" value="10:20 03/20/2018" /></p>
         * <p><label for="large">Large Size:</label> <input id="large" width="234" value="10:20 03/20/2018" /></p>
         * <script>
         *     $('#small').datetimepicker1({ uiLibrary: 'bootstrap4', iconsLibrary: 'fontawesome', size: 'small' });
         *     $('#default').datetimepicker1({ uiLibrary: 'bootstrap4', iconsLibrary: 'fontawesome', size: 'default' });
         *     $('#large').datetimepicker1({ uiLibrary: 'bootstrap4', iconsLibrary: 'fontawesome', size: 'large' });
         * </script>
         * @example Bootstrap.3 <!-- bootstrap, datetimepicker1 -->
         ...
         * <script>
         *     $('#small').datetimepicker1({ uiLibrary: 'bootstrap', size: 'small' });
         *     $('#default').datetimepicker1({ uiLibrary: 'bootstrap', size: 'default' });
         *     $('#large').datetimepicker1({ uiLibrary: 'bootstrap', size: 'large' });
         * </script>
         * @example Material.Design <!-- datetimepicker1 -->
         ...
         * <script>
         *     $('#small').datetimepicker1({ size: 'small' });
         *     $('#default').datetimepicker1({ size: 'default' });
         *     $('#large').datetimepicker1({ size: 'large' });
         * </script>
         */
        size: 'default',
         ...
         * @type string
         * @default 'en-us'
         * @example German <!-- datetimepicker1 -->
         ...
         *    });
         * </script>
         * @example Bulgarian <!-- datetimepicker1 -->
         * <input id="input" width="276" />
         * <script>
         *    $('#input').datetimepicker1({
         *        locale: 'bg-bg',
        ...
        style: {
            calendar: 'gj-picker gj-picker-md datetimepicker1 gj-unselectable'
        }
    },

    bootstrap: {
        style: {
            calendar: 'gj-picker gj-picker-bootstrap datetimepicker1 gj-unselectable'
        },
        iconsLibrary: 'glyphicons'
    },
...
gj.datetimepicker1.methods = {
    init: function(jsConfig) {
        gj.widget.prototype.init.call(this, jsConfig, 'datetimepicker1');
        this.attr('data-datetimepicker1', 'true');
        gj.datetimepicker1.methods.initialize(this);
        return this;
    },
    ...
    getConfig: function(clientConfig, type) {
        ...
        if (gj.timepicker1.config[uiLibrary]) {
            $.extend(true, config.timepicker1, gj.timepicker1.config[uiLibrary]);
        }
        ...
        if (gj.timepicker1.config[iconsLibrary]) {
            $.extend(true, config.timepicker1, gj.timepicker1.config[iconsLibrary]);
        }

        return config;
    },

    initialize: function($datetimepicker1) {
        ...
        gj.datepicker.methods.initialize($datetimepicker1, data.datepicker);
        $datetimepicker1.on('select', function(e, type) {
            var date, value;
            if (type === 'day') {
                gj.datetimepicker1.methods.createShowHourHandler($datetimepicker1, $picker, data)();
            } else if (type === 'minute') {
                if ($picker.attr('selectedDay') && data.footer !== true) {
                    ...
                    value = gj.core.formatDate(date, data.format, data.locale);
                    $datetimepicker1.val(value);
                    gj.datetimepicker1.events.change($datetimepicker1);
                    gj.datetimepicker1.methods.close($datetimepicker1);
                }
            }
        });
        $datetimepicker1.on('open', function() {
        ...
        $picker = $('body').find('[role="calendar"][guid="' + $datetimepicker1.attr('data-guid') + '"]');
        ...
        // Init timepicker1
        data.timepicker1.uiLibrary = data.uiLibrary;
        data.timepicker1.iconsLibrary = data.iconsLibrary;
        data.timepicker1.format = data.format;
        data.timepicker1.locale = data.locale;
        data.timepicker1.header = true;
        data.timepicker1.footer = data.footer;
        data.timepicker1.size = data.size;
        data.timepicker1.mode = '24hr';
        data.timepicker1.autoClose = false;

        // Init header        
        $header = $('<div role="header" />');
        $date = $('<div role="date" class="selected" />');
        $date.on('click', gj.datetimepicker1.methods.createShowDateHandler($datetimepicker1, $picker, data));
        ...
        $calendarMode.on('click', gj.datetimepicker1.methods.createShowDateHandler($datetimepicker1, $picker, data));
        $switch.append($calendarMode);

        $time = $('<div role="time" />');
        $time.append($('<div role="hour" />').on('click', gj.datetimepicker1.methods.createShowHourHandler($datetimepicker1, $picker, data)).html(gj.core.formatDate(new Date(), 'HH', data.locale)));
        $time.append(':');
        $time.append($('<div role="minute" />').on('click', gj.datetimepicker1.methods.createShowMinuteHandler($datetimepicker1, $picker, data)).html(gj.core.formatDate(new Date(), 'MM', data.locale)));
        $switch.append($time);

        $clockMode = $('<i class="gj-icon" role="clockMode">clock</i>');
        $clockMode.on('click', gj.datetimepicker1.methods.createShowHourHandler($datetimepicker1, $picker, data));
    ...
    createShowDateHandler: function($datetimepicker1, $picker, data) {
        return function(e) {
            var $header = $picker.children('[role="header"]');
            $header.find('[role="calendarMode"]').addClass("selected");
            ...
            gj.datepicker.methods.renderMonth($datetimepicker1, $picker, data.datepicker);
        };
    },

    createShowHourHandler: function($datetimepicker1, $picker, data) {
        return function() {
            var $header = $picker.children('[role="header"]');
            ...
            gj.timepicker1.methods.initMouse($picker.children('[role="body"]'), $datetimepicker1, $picker, data.timepicker1);
            gj.timepicker1.methods.renderHours($datetimepicker1, $picker, data.timepicker1);
        };
    },

    createShowMinuteHandler: function($datetimepicker1, $picker, data) {
        return function() {
            var $header = $picker.children('[role="header"]');
            $header.find('[role="calendarMode"]').removeClass("selected");
            $header.find('[role="date"]').removeClass("selected");
            ...
            gj.timepicker1.methods.initMouse($picker.children('[role="body"]'), $datetimepicker1, $picker, data.timepicker1);
            gj.timepicker1.methods.renderMinutes($datetimepicker1, $picker, data.timepicker1);
        };
    },

    close: function($datetimepicker1) {
        var $calendar = $('body').find('[role="calendar"][guid="' + $datetimepicker1.attr('data-guid') + '"]');
        $calendar.hide();
        $calendar.closest('div[role="modal"]').hide();
        //gj.datepicker.events.close($datepicker);
    },

    value: function($datetimepicker1, value) {
        var $calendar, date, hour, data = $datetimepicker1.data();
        if (typeof(value) === "undefined") {
            return $datetimepicker1.val();
        } else {
            date = gj.core.parseDate(value, data.format, data.locale);
            if (date) {
                $calendar = $('body').find('[role="calendar"][guid="' + $datetimepicker1.attr('data-guid') + '"]');
                gj.datepicker.methods.dayClickHandler($datetimepicker1, $calendar, data, date)();
                // Set Time
                hour = date.getHours();
                if (data.mode === 'ampm') {
    ...
    destroy: function($datetimepicker1) {
        var data = $datetimepicker1.data(),
            $parent = $datetimepicker1.parent(),
            $picker = $('body').find('[role="calendar"][guid="' + $datetimepicker1.attr('data-guid') + '"]');
        if (data) {
            $datetimepicker1.off();
            if ($picker.parent('[role="modal"]').length > 0) {
            ...
            $picker.remove();
            $datetimepicker1.removeData();
            $datetimepicker1.removeAttr('data-type').removeAttr('data-guid').removeAttr('data-datetimepicker1');
            $datetimepicker1.removeClass();
            $parent.children('[role="right-icon"]').remove();
            $datetimepicker1.unwrap();
        }
        return $datetimepicker1;
    }
};

gj.datetimepicker1.events = {
    /**
     * Fires when the datetimepicker1 value changes as a result of selecting a new value.
     *
     * @event change
     * @param {object} e - event data
     * @example sample <!-- datetimepicker1 -->
     ...
     * </script>
     */
    change: function($datetimepicker1) {
        return $datetimepicker1.triggerHandler('change');
    }
};

gj.datetimepicker1.widget = function($element, jsConfig) {
    var self = this,
        methods = gj.datetimepicker1.methods;

    self.mouseMove = false;

    /** Gets or sets the value of the datetimepicker1.
     * @method
     * @param {string} value - The value that needs to be selected.
     * @return string
     * @example Get <!-- datetimepicker1 -->
     * <button class="gj-button-md" onclick="alert($datetimepicker1.value())">Get Value</button>
     * <hr/>
     * <input id="datetimepicker1" width="312" value="17:50 03/27/2018" />
     * <script>
     *     var $datetimepicker1 = $('#datetimepicker1').datetimepicker1();
     * </script>
     * @example Set <!-- datetimepicker1 -->
     * <button class="gj-button-md" onclick="$datetimepicker1.value('13:40 08/01/2017')">Set Value</button>
     * <hr/>
     * <input id="datetimepicker1" width="312" />
     * <script>
     *     var $datetimepicker1 = $('#datetimepicker1').datetimepicker1();
    ...
    /** Remove datetimepicker1 functionality from the element.
     * @method
     * @return jquery element
     * @example sample <!-- datetimepicker1 -->
     * <button class="gj-button-md" onclick="datetimepicker1.destroy()">Destroy</button>
     * <input id="datetimepicker1" width="312" />
     * <script>
     *     var datetimepicker1 = $('#datetimepicker1').datetimepicker1();
     * </script>
    ...
    $.extend($element, self);
    if ('true' !== $element.attr('data-datetimepicker1')) {
        methods.init.call($element, jsConfig);
    }
...
gj.datetimepicker1.widget.prototype = new gj.widget();
gj.datetimepicker1.widget.constructor = gj.datetimepicker1.widget;

gj.datetimepicker1.widget.prototype.getConfig = gj.datetimepicker1.methods.getConfig;

(function($) {
    $.fn.datetimepicker1 = function(method) {
        var $widget;
        if (this && this.length) {
            if (typeof method === 'object' || !method) {
                return new gj.datetimepicker1.widget(this, method);
            } else {
                $widget = new gj.datetimepicker1.widget(this, null);
                if ($widget[method]) {
                    return $widget[method].apply(this, Array.prototype.slice.call(arguments, 1));
                } else {
                    throw 'Method ' + method + ' does not exist.';
