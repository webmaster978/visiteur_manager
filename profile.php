                ...
                <div class="col-lg-4 col-md-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="map-box">
                                <iframe src="https://www.google.com/maps/place/Uptodatedevelopers/@-1.6835327,29.2341779,795m/data=!3m2!1e3!4b1!4m5!3m4!1s0x19dd05237814b24d:0x236dcd3de55c749c!8m2!3d-1.6835381!4d29.2363666" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen=""></iframe>
                            </div>
                            <br>
                        </div>
                    </div>
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="card">
                        <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="pills-timeline-tab" data-toggle="pill" href="#current-month" role="tab" aria-controls="pills-timeline" aria-selected="false">Journale</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#last-month" role="tab" aria-controls="pills-profile" aria-selected="false">Securite</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active show" id="pills-setting-tab" data-toggle="pill" href="#previous-month" role="tab" aria-controls="pills-setting" aria-selected="true">Paramettre</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                <div class="card-body">
                                    <div class="profiletimeline mt-0">
                                        <div class="sl-item">
                                            <div class="sl-left"> <img src="<?php echo $row["admin_profile"];  ?>" alt="user" class="rounded-circle" width="150"> </div>
                                            <div class="sl-right">
                                                <div><a href="javascript:void(0)" class="link"><?php echo $row['admin_name']; ?></a> <span class="sl-date">5 minutes ago</span>
                                                    <p>assign a new task <a href="javascript:void(0)"> Design weblayout</a>
                                                    </p>
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 mb-20"><img src="<?php echo $row["admin_profile"];  ?>" class="img-fluid rounded"></div>
                                                        <div class="col-lg-3 col-md-6 mb-20"><img src="<?php echo $row["admin_profile"];  ?>" class="img-fluid rounded"></div>
                                                        <div class="col-lg-3 col-md-6 mb-20"><img src="<?php echo $row["admin_profile"];  ?>" class="img-fluid rounded"></div>
                                                        <div class="col-lg-3 col-md-6 mb-20"><img src="<?php echo $row["admin_profile"];  ?>" class="img-fluid rounded"></div>
                                                    </div>
                            ...
                            <div class="tab-pane fade" id="last-month" role="tabpanel" aria-labelledby="pills-profile-tab">
                                <div class="card-body">
                                    ...
                                    <form method="post" id="user_form">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-md-4 text-right">Nouveau mot de passe <span class="text-danger">*</span></label>
                                                <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-md-4 text-right">Confirmer le nouveau mot de passe <span class="text-danger">*</span></label>
                                                <div class="col-md-8">
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <button type="submit" name="submit" id="submit_button" class="btn btn-success"><i class="fas fa-lock"></i> Modifier</button>
                                        </div>
                                    </form>
                            ...
                            <div class="tab-pane fade active show" id="previous-month" role="tabpanel" aria-labelledby="pills-setting-tab">
                                <div class="card-body">
                                    <form method="post" id="user_form" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" name="submit" id="submit_button" class="btn btn-success"><i class="far fa-save"></i> Modifier</button>
                                    </form>
                                </div>
                            </div>
                        </div>
